...
\bx{ % 2.8.6
    ...
    \sol{\ea{
        ...
        \item We will first note that $\sum_{k=2}^{n} d_k$ contains all the terms of $s_{pp}$ when $p \leq n/2$, and $s_{qq}$ contains all the terms of $\sum_{k=2}^{n} d_k$ when $q \geq n-1$. Intuitively, we can use Squeeze Theorem to show our desired sum converges to $S$. However, we will be following a more rigourous path to form our proof as desired by the question.
