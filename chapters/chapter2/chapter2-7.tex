...
\bx{ %2.7.8
    ...
    \sol{\ea{
        ...
        \item True. Suppose $\sum n^2 a_n$ converges, since $(n^2a_n) \rightarrow 0$, we have $|n^2a_n| < \epsilon$ for $n > N$, implying $|a_n| < 1/n^2$. By comparsion test, $\sum |a_n| < \sum 1/n^2$ converges, implying $\sum a_n$ converges absolutely, which is a contradiction. Therefore $\sum n^2 a_n$ must diverge.
    }}
}